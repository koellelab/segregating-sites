# ------------------
## next_dt.py (SEIR without tranmission heterogeneity)
# ------------------
import numpy as np
import sys
...
from SEIR_simple import gillespie
from SEIR_simple import genotype_count as genotype_count_
...
def update (particle, param, this_win_start, this_win_end):
    ...
    every_clade_3 = np.arange(param['n_clades']) * param['n_class'] + 2
