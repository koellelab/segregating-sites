...
class Particle():
    def __init__(self, n_clade, n_class, init_size = 10):
        ...
        self.n_segregating = np.empty([init_size, n_clade+1], dtype='float64')
        self.cmp_nu = np.empty([init_size, n_clade + 1], dtype='float64')
        self.cmp_lambda = np.empty([init_size, n_clade + 1], dtype='float64')
