...
def run(axes = None, metadata = None, logFile = None, argv=[]):
    ...
    parser.add_argument('--trueR0', default=1.6, type=float)
    parser.add_argument('--trueT0', default=0.0, type=float)
    ...
    # axis labels
    ax2.set_xlabel(r'$R_0$', fontsize=14)
    ax2.set_ylabel('time of MRCA (days)', fontsize=12)
