...
def run(dir_simulated_dataset, dir_likelihood_randsearch, true_param, xlim, ylim, figname):
    ...
    fig = plt.figure(figsize=[8, 2.85], constrained_layout=True, dpi = 300)
    gs  = fig.add_gridspec(2, 3, height_ratios=[0.9, 0.4])
    ...
    sampling_prop_over_time(axes[3], data=df_simulated_dataset)
