...
import utils
from models.simpleSEIR import gillespie
from models.simpleSEIR import genotype_count as genotype_count_
...
def update (particle, param, this_win_start, this_win_end):
    ...
    for idx in range(len(t_range)):
        ...
        #print(f"n_events, {t_now_end:}, {event_count_infection[0]}, {event_count_transition[0]}, {event_count_transition[1]}\n")
        ...
        genotype_count_from_infection, n_new_genotype, particle.genotype_info, particle.n_site[0] = genotype_count_.infection_event_mutate (event_count_infection, statevar_curr, genotype_count, 0, particle.genotype_info, n_genotype, particle.n_site[0], param['mu_multinom'], param['rng2'])
