...
import utils
from models.heteroSEIR import gillespie
from models.heteroSEIR import genotype_count as genotype_count_
...
def update(particle, param, this_win_start, this_win_end):
    ...
    for idx in range(len(t_range)):
        ...
        #check_binom[:2] += event_count_transition[:2]
