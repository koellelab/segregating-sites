...
if [ $(pwd | grep ypar279 | wc -l) -eq 1 ];then   ## run from server
  ...
  single)
    ...
    python $PEM_PATH/../eiuss/eiuss.py gridsearch \
        ...
        --n_reps            10 \
        --operators         timestart R0 \
        --range             "2020/01/15:2019/11/30:-3;${2}:${2}1:0.1" \
        --seed              202303${4}\
        ${5}
      ;;
  ...
  run)
    ...
    sh ../run_remote.sh   bio_run  session_2023-02-22.log   'for i in {5..9} ;do sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  single_expand 2.${i} 2.${i} 3${i} --continued; done'
    sh ../run_remote.sh   bio_run  session_2023-02-22.log   'for i in {0..9} ;do sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  single_expand 3.${i} 3.${i} 4${i} --continued; done'
    sh ../run_remote.sh   bio_run  session_2023-02-22.log   'for i in {0..5} ;do sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  single_expand 4.${i} 4.${i} 5${i} --continued; done'
...
#    sh ../run_remote.sh   rsph_run ../session_2023-03-01_france_multi_2D.log   'for i in {0..9} ;do sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  multi0108_expand 2.${i}   2.${i}1 3${i} --continued; done'
    ...
    #sh ../run_remote.sh   rsph_run ../session_2023-03-01_france_multi_2D.log                       'sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  multi1224_expand 4        4.01    50'
    #sh ../run_remote.sh   rsph_run ../session_2023-03-01_france_multi_2D.log                       'sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  multi0101_expand 4        4.01    50'
    #sh ../run_remote.sh   rsph_run ../session_2023-03-01_france_multi_2D.log                       'sbatch empirical_data/france_data/run_2D-loglikelihood_server.sh  multi0108_expand 4        4.01    50'
